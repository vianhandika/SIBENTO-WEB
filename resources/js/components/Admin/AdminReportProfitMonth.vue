<template>
    <div>
        <v-toolbar flat color="white">
          ...
          <v-toolbar-title>Report Profit Bulanan</v-toolbar-title>
          <v-divider
              class="mx-2"
              inset
              vertical
        ...
        <v-layout >
          <v-flex xs7>
            ...
            <template v-slot:items="props">
                ...
                <td class="text-xs-right">Rp. {{ props.item.Service }}</td>
                <td class="text-xs-right">Rp. {{ props.item.Sparepart }}</td>
  ...
  export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Service', align: 'center', value: 'Service' ,sortable: false},
        { text: 'Sparepart', align: 'center',value: 'Sparepart', sortable: false },
    ...
    methods: {
      ...
      ...mapActions({
          getReport: 'Report/profitPerMonth',
      ...
      print(){
          window.open(`/api/report/profitmonth-pdf/${this.year}`, '_blank')
