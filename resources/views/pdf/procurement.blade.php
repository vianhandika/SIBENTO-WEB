...
<body>
	<div class="container">
		...
		<div class="consignee-section">
				Kepada Yth:
				<div>{{ $procurement->sales->supplier->name_supplier }}</div>
				<div>{{ $procurement->sales->supplier->address_supplier }}</div>
				<div>{{ $procurement->sales->supplier->phone_number_supplier }}</div>
			</div>
