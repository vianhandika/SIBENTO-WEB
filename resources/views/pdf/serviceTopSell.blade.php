...
<html>
<head>
	<title>Report Penjualan Jasa</title>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td>{{ $item->name_motorcycle_brand }}</td>
						<td style="text-align:left;">{{ $item->name_motorcycle_type }}</td>
                        <td style="text-align:left;">{{ $item->name_service }}</td>
