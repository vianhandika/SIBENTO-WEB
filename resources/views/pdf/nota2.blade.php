            ...
            <table class="sparepart-details border_bottom_upper">
                ...
                <tbody> 
                    <tr>
                        ...
                        <td></td>
                        <td></td> 
                        <td style="text-align:right;">Rp. {{$transaction->detail_transaction_sparepart->sum('subtotal_transaction_sparepart')}}</td> 
                    </tr>
            ...
            <table class="service-details border_bottom_upper">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td style="text-align:right;">Rp. {{$transaction->detail_transaction_service->sum('subtotal_transaction_service')}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <table class="service-details">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- <td style="text-align:right;">Rp. 50000000</td> -->
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">Rp. {{ $transaction->discount_transaction}}</td>
                    ...
                    <tr>
                        ...
                        <!-- <td style="text-align:right; font-weight: bold; font-size: 18px;">Rp. 50000000</td> -->
